...
public extension NSUserActivity {
    ...
    class func openExampleActivity(withPreferredExampleLanguage preferredExampleLanguage: PSCExampleLanguage, indexPath: IndexPath) -> NSUserActivity {
    ...
    var preferredExampleLanguage: PSCExampleLanguage {
        guard self.isOpenExampleActivity,
            ...
            let catalogExampleLanguage = PSCExampleLanguage(rawValue: rawLanguageValue) else {
                return .swift
        }
