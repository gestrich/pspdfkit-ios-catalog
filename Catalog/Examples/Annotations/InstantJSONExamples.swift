...
class InstantJSONAnnotationExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController {
        let document = AssetLoader.writableDocument(withName: .quickStart, overrideIfExists: true)
...
class InstantJSONDocumentExample: Example {
    ...
    class InstantJSONDocumentPDFController: PDFViewController {
        ...
        @objc func exportInstantJSON(_ sender: AnyObject) {
            ...
            // Reload the document
            let reloadedDocument = AssetLoader.writableDocument(withName: .quickStart, overrideIfExists: true)
