...
class AddNoteAnnotationProgrammaticallyExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        let documentURL = AssetLoader.assetURL(withName: .annualReport)
...
class AddFileAnnotationProgrammaticallyExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        let document = AssetLoader.writableDocument(withName: .quickStart, overrideIfExists: false)
        let embeddedFileURL = AssetLoader.assetURL(withName: "PSPDFKit Logo.pdf")
...
class AddFreeTextAnnotationProgrammaticallyExample: Example, PDFViewControllerDelegate {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        let document = AssetLoader.writableDocument(withName: .annualReport, overrideIfExists: false)
