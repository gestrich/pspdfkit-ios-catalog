...
@interface PSCAddTextToFreeTextAnnotationAtCaretPositionExample : PSCExample
...
@implementation PSCAddTextToFreeTextAnnotationAtCaretPositionExample
...
- (void)insertTextTapped:(id)sender {
    ...
    NSDictionary *options = @{ PSPDFPresentationOptionPopoverArrowDirections: @(UIPopoverArrowDirectionDown), PSPDFPresentationOptionNonAdaptive: @YES, PSPDFPresentationOptionInNavigationController: @YES };
