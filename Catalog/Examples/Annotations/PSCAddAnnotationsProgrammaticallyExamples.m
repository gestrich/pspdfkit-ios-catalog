...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    if ([document annotationsForPageAtIndex:targetPage type:PSPDFAnnotationTypeInk].count == 0) {
        ...
        annotation.color = [UIColor colorWithRed:0.667 green:0.279 blue:0.748 alpha:1.0];
...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    NSArray <PSPDFGlyph *> *glyphs = [document objectsAtPDFRect:textSelectionRect pageIndex:pageIndex options:@{PSPDFObjectFinderOptionExtractGlyphs : @YES}][PSPDFObjectFinderTypeGlyphs];
...
#pragma mark - PSCAnnotationsProgrammaticallyCreateAnnotationsExample

@interface PSCAnnotationsProgrammaticallyCreateAnnotationsExample : PSCExample
@end
@implementation PSCAnnotationsProgrammaticallyCreateAnnotationsExample
...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    if ([document annotationsForPageAtIndex:pageIndex type:PSPDFAnnotationTypePolyLine].count == 0) {
        ...
        polyline.color = [UIColor colorWithRed:0.0 green:1.0 blue:0.0 alpha:1.0];
...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    if ([document annotationsForPageAtIndex:pageIndex type:PSPDFAnnotationTypeSquare].count == 0) {
        ...
        annotation.color = [UIColor colorWithRed:0.0 green:100.0 / 255. blue:0.0 alpha:1.0];
