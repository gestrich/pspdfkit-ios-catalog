...
private class ToggleAnnotationVisibilityViewController: PDFViewController {
    ...
    override func commonInit(with document: Document?, configuration: PDFConfiguration) {
        ...
        let toggleAnnotationVisibilityBarButtonItem = UIBarButtonItem(image: UIImage.psc_image(named: "hide"), style: .plain, target: self, action: #selector(didTapToggleAnnotationVisibilityBarButtonItem))
