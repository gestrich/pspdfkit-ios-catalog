...
class PSPDFSnakeExample: Example {
    ...
    func createDocument() -> Document {
        ...
        let outputFileURL = TempFileURLWithPathExtension(prefix: "new-document", pathExtension: "pdf")
        do {
...
private class SnakeViewController: PDFViewController {
    ...
    private func addKeyCommands() {
        let up = UIKeyCommand(input: UIKeyCommand.inputUpArrow, modifierFlags: [], action: #selector(goUp))
        let down = UIKeyCommand(input: UIKeyCommand.inputDownArrow, modifierFlags: [], action: #selector(goDown))
        let left = UIKeyCommand(input: UIKeyCommand.inputLeftArrow, modifierFlags: [], action: #selector(goLeft))
        let right = UIKeyCommand(input: UIKeyCommand.inputRightArrow, modifierFlags: [], action: #selector(goRight))
        let p = UIKeyCommand(input: "p", modifierFlags: [], action: #selector(pause))
        addKeyCommand(up)
        addKeyCommand(down)
        addKeyCommand(left)
        addKeyCommand(right)
