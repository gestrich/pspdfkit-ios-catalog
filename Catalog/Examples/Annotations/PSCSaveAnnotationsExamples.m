...
- (void)commonInitWithDocument:(PSPDFDocument *)document configuration:(PSPDFConfiguration *)configuration {
    ...
    UIBarButtonItem *saveButton = [[UIBarButtonItem alloc] initWithTitle:@"Save" style:UIBarButtonItemStylePlain target:self action:@selector(saveAnnotations)];
...
- (void)saveAnnotations {
    ...
    if (![self.document saveWithOptions:nil error:&error]) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Failed to save annotations" message:error.localizedDescription preferredStyle:UIAlertControllerStyleAlert];
        ...
        //[[[UIAlertView alloc] initWithTitle:@"Success" message:[NSString stringWithFormat:@"Saved %d annotation(s)", dirtyAnnotationCount] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
