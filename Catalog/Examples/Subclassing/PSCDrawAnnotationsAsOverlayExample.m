...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    // register our custom annotation provider as subclass before the controller is initialized.
...
- (void)pdfViewController:(PSPDFViewController *)pdfController didConfigurePageView:(PSPDFPageView *)pageView forPageAtIndex:(NSInteger)pageIndex {
    ...
    customView.layer.borderColor = [UIColor colorWithRed:1.0 green:0.846 blue:0.088 alpha:1.0].CGColor;
