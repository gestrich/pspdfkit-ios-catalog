...
- (instancetype)init {
    if ((self = [super init])) {
        ...
        self.contentDescription = @"Search programmatically without displaying search controller.";
...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    pdfController.highlightedSearchText = @"Annual";
...
- (void)updateTextHighlight {
    [self searchForString:self.highlightedSearchText options:@{PSPDFPresentationOptionSearchHeadless: @YES} sender:nil animated:NO];
}
