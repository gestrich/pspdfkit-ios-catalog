...
final class ReportPDFGenerationExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        // Get base document
        let document = AssetLoader.document(withName: .annualReport)
        ...
        let quickStartDocument = AssetLoader.document(withName: .quickStart)
        ...
        let processedDocumentURL = TempFileURLWithPathExtension(prefix: "processed", pathExtension: "pdf")
    ...
    private func generateSecondPage(pageInfo: PDFPageInfo) -> Document {
        ...
        let logoURL = AssetLoader.assetURL(withName: "PSPDFKit Logo.pdf")
        ...
        let flattenedSecondPageOutputFileURL = TempFileURLWithPathExtension(prefix: "flattened-second-page", pathExtension: "pdf")
