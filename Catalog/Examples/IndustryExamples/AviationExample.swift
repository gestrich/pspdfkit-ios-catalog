...
class AviationExample: IndustryExample {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        if #available(iOS 13, *) {
            // Force Dark Mode on iOS 13 and later.
...
private class FlightManualContainerController: UIViewController, MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        if annotationView == nil {
            ...
            annotationView?.image = UIImage.psc_image(named: "airplane")
...
private class FlightManualPDFViewController: AviationPDFViewController {
    ...
    init(with example: IndustryExample) {
        let document = AssetLoader.writableDocument(withName: .flightManual, overrideIfExists: false)
        document.title = "Flight Manual"

        // Customize document sharing.
        // See https://pspdfkit.com/guides/ios/current/miscellaneous/document-sharing/ for more details.
        ...
        // See https://pspdfkit.com/guides/ios/current/customizing-the-interface/appearance-mode-manager/ for more details.
...
private class PassengerListPDFViewController: AviationPDFViewController {
    ...
    init(with example: IndustryExample) {
        let document = AssetLoader.writableDocument(withName: .passengerList, overrideIfExists: false)
...
private class AviationPDFViewController: PDFViewController, PDFViewControllerDelegate {
    ...
    override func commonInit(with document: Document?, configuration: PDFConfiguration) {
        ...
        // See https://pspdfkit.com/guides/ios/current/annotations/stamp-annotations-configuration/ for more details.
    ...
    func pdfViewController(_ pdfController: PDFViewController, shouldShow controller: UIViewController, options: [String: Any]? = nil, animated: Bool) -> Bool {
        ...
        // Force Dark Mode on iOS 13 and later for presented controllers.
        if #available(iOS 13, *) {
...
private class AviationAnnotationToolbar: AnnotationToolbar {
    ...
    override init(annotationStateManager: AnnotationStateManager) {
        ...
        // See https://pspdfkit.com/guides/ios/current/customizing-the-interface/customizing-the-annotation-toolbar/#annotation-buttons for more details.
