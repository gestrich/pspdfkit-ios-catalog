...
private class EreaderPDFViewController: PDFViewController {
    ...
    init(with example: IndustryExample) {
        let document = AssetLoader.writableDocument(withName: .psychologyResearch, overrideIfExists: false)
        ...
        // See https://pspdfkit.com/guides/ios/current/customizing-the-interface/the-document-view-hierarchy/#customizing-the-layout for more details.
