...
private class ConstructionPDFViewController: PDFViewController, PDFViewControllerDelegate, PDFDocumentPickerControllerDelegate {
    ...
    init(with example: IndustryExample) {
        let document = AssetLoader.writableDocument(withName: .constructionPlan, overrideIfExists: false)
        ...
        // See https://pspdfkit.com/guides/ios/current/annotations/customizing-presets/ for more details.
        let presets = [
    ...
    override func viewDidLoad() {
        ...
        // See https://pspdfkit.com/guides/ios/current/customizing-the-interface/customizing-the-available-document-information/ for more details.
    ...
    private lazy var toggleAnnotationVisibilityBarButtonItem: UIBarButtonItem = {
        let toggleAnnotationVisibility = UIBarButtonItem(image: UIImage.psc_image(named: "hide"), style: .plain, target: self, action: #selector(didTapToggleAnnotationVisibilityBarButtonItem))
    ...
    @objc func didTapToggleAnnotationVisibilityBarButtonItem(_ sender: UIBarButtonItem) {
        ...
        if sender.title == "hide" {
            ...
            sender.title = "show"
            sender.image = UIImage.psc_image(named: "show")
        } else {
            setVisibleAnnotationTypes(.all)
            sender.title = "hide"
            sender.image = UIImage.psc_image(named: "hide")
        }
    }
    ...
    private func setDefault(colorPresets: [ColorPreset]?, defaultColor: UIColor?) {
        ...
        // See https://pspdfkit.com/guides/ios/current/annotations/changing-default-values-for-color-and-text-size-of-annotations/ for more details.
    ...
    @objc func addPinAnnotationGestureRecognizerDidChangeState(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        // See https://pspdfkit.com/guides/ios/current/faq/coordinate-spaces/ for more details.
        ...
        // See https://pspdfkit.com/guides/ios/current/annotations/programmatically-creating-annotations/#stamp-annotations for more details.
        ...
        // See https://pspdfkit.com/guides/ios/current/annotations/custom-data-in-annotations/#storing-custom-data for more details.
    ...
    /// See https://pspdfkit.com/guides/ios/current/customizing-the-interface/customizing-menus/ for more details.
...
/// See https://pspdfkit.com/guides/ios/current/customizing-the-interface/customizing-the-annotation-toolbar/ for more details.
private class ConstructionAnnotationToolbar: AnnotationToolbar {
    ...
    override init(annotationStateManager: AnnotationStateManager) {
        ...
        let cloudyCircle = Item(type: .circle, variant: Annotation.Variant(rawValue: "Cloudy Ellipse")) {_, _, _ in
            return UIImage.psc_image(named: "ellipse_cloudy")!.withRenderingMode(.alwaysTemplate)
        }
        let dashedCircle = Item(type: .circle, variant: Annotation.Variant(rawValue: "Dashed Ellipse")) {_, _, _ in
            return UIImage.psc_image(named: "ellipse_dashed")!.withRenderingMode(.alwaysTemplate)
        }
        ...
        let cloudySquare = Item(type: .square, variant: Annotation.Variant(rawValue: "Cloudy Rectangle")) {_, _, _ in
            return UIImage.psc_image(named: "rectangle_cloudy")!.withRenderingMode(.alwaysTemplate)
        }
        let dashedSquare = Item(type: .square, variant: Annotation.Variant(rawValue: "Dashed Rectangle")) {_, _, _ in
            return UIImage.psc_image(named: "rectangle_dashed")!.withRenderingMode(.alwaysTemplate)
        }
        ...
        pinStampButton.image = UIImage.psc_image(named: "pin_drop")!.withRenderingMode(.alwaysTemplate)
...
// See https://pspdfkit.com/guides/ios/current/annotations/customize-annotation-rendering/#customize-or-hide-the-note-icon for more details.
