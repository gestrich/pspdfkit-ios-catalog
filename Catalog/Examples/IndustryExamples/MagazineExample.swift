...
private class MagazinePDFViewController: PDFViewController {
    ...
    init(with example: IndustryExample) {
        let document = AssetLoader.writableDocument(withName: .magazine, overrideIfExists: false)
        ...
        let configuration = PDFConfiguration {
            ...
            // See https://pspdfkit.com/guides/ios/current/customizing-the-interface/document-presentation-options/ for more details.
            ...
            // See https://pspdfkit.com/guides/ios/current/features/controlling-pdf-editing/#disable-the-modification-of-all-annotation-types for more details.
