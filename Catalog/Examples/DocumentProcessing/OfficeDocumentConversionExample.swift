...
private class OfficeDocumentPickerTableViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        /// https://pspdfkit.com/guides/server/current/pspdfkit-server/client-authentication/#special-notes-for-the-mobile-document-conversion
        ///
        ...
        return [
            Section(header: "Office file conversion powered by PSPDFKit Server", rows: [], footer: "NOTE: This example needs a local instance of PSPDFKit Server which supports running Office file conversion. Steps to setup the local server can be found at: https://pspdfkit.com/guides/ios/current/features/office-conversion/. If using a non-local PSPDFKit Server, change the server URL appropriately."),
    ...
    private func convertAndPresentDocument(withIdentifier identifier: OfficeDocument) {
        ...
        ///
        /// Steps to setup the local server can be found at: https://pspdfkit.com/guides/ios/current/features/office-conversion/
        ///
