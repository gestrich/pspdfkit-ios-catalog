...
final class FaceRedactionExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController {
        let document = AssetLoader.document(withName: AssetName(rawValue: "FaceRedaction.pdf"))
    ...
    final class FaceRedactionPDFViewController: PDFViewController {
        ...
        @objc func applyRedactions() {
            ...
            let redactedDocumentURL = TempFileURLWithPathExtension(prefix: "redacted", pathExtension: "pdf")
