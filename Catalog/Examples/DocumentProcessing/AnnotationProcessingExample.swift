...
private final class AnnotationProcessingPDFViewController: PDFViewController {
    ...
    private func embedAnnotations() {
        let embeddedDocumentURL = TempFileURLWithPathExtension(prefix: "embedded", pathExtension: "pdf")
    ...
    private func flattenAnnotations() {
        let flattenedDocumentURL = TempFileURLWithPathExtension(prefix: "flattened", pathExtension: "pdf")
    ...
    private func removeAnnotations() {
        let removedAnnotationsDocumentURL = TempFileURLWithPathExtension(prefix: "removedAnnotations", pathExtension: "pdf")
