...
- (NSArray<PSPDFAnnotation *> *)annotationsForPageAtIndex:(PSPDFPageIndex)pageIndex {
    ...
    @synchronized(self) {
        ...
        if (!annotations) {
            ...
            noteAnnotation.boundingBox = CGRectMake(100.0, pageInfo.size.height - 100.0, 32.0, 32.0);
...
- (NSArray<__kindof PSPDFAnnotation *> *)addAnnotations:(NSArray<__kindof PSPDFAnnotation *> *)annotations options:(nullable NSDictionary<PSPDFAnnotationOption, id> *)options {
