...
class ComparisonExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController {
        let firstDocument = AssetLoader.document(withName: AssetName(rawValue: "FloorPlan_1.pdf"))
        let secondDocument = AssetLoader.document(withName: AssetName(rawValue: "FloorPlan_2.pdf"))
