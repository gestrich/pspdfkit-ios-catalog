...
class WebExamplesAPIClient: NSObject, URLSessionTaskDelegate {
    ...
    func createNewSession(documentIdentifier: String, completion: @escaping CompletionHandler) {
        var request = URLRequest(url: URL(string: "https://web-examples.pspdfkit.com/api/\(documentIdentifier)")!)
