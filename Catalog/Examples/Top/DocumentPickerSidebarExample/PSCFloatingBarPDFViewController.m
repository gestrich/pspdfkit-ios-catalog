...
- (void)updateFloatingToolbarAnimated:(BOOL)animated {
    ...
    [thumbnailButton setImage:[[PSPDFKitGlobal imageNamed:@"thumbnails"] psc_imageTintedWithColor:UIColor.whiteColor fraction:0.0] forState:UIControlStateNormal];
    ...
    if (self.document.documentProviders.firstObject.outlineParser.isOutlineAvailable) {
        ...
        [outlineButton setImage:[[PSPDFKitGlobal imageNamed:@"outline"] psc_imageTintedWithColor:UIColor.whiteColor fraction:0.0] forState:UIControlStateNormal];
    ...
    [searchButton setImage:[[PSPDFKitGlobal imageNamed:@"search"] psc_imageTintedWithColor:UIColor.whiteColor fraction:0.0] forState:UIControlStateNormal];
