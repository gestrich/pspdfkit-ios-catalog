...
class EmebedContainedSignatureExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController {
        ...
        let document = AssetLoader.writableDocument(withName: "DocumentPreparedToBeSigned.pdf", overrideIfExists: true)
        let newURL = document.fileURL!
        ...
        let preparedSignatureSampleURL = AssetLoader.assetURL(withName: "DocumentPreparedToBeSigned.bin")
