...
class EmebedContainedPadesSignatureExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController {
        ...
        let document = AssetLoader.writableDocument(withName: "PreparedToBePadesSignedDocument.pdf", overrideIfExists: true)
        let newURL = document.fileURL!
        ...
        let preparedSignatureSampleURL = AssetLoader.assetURL(withName: "PreparedToBePadesSignedSignature.bin")
