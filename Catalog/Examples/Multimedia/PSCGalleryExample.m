...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    audioAnnotation.boundingBox = CGRectMake(annotationPosition.x - annotationSize.width / 2.0, annotationPosition.y - annotationSize.height / 2.0, annotationSize.width, annotationSize.height);
    ...
    // Dynamically add Vimeo video box on page 4
    PSPDFLinkAnnotation *vimeo = [[PSPDFLinkAnnotation alloc] initWithURL:(NSURL *)[NSURL URLWithString:@"pspdfkit://vimeo.com/1084537"]];
    vimeo.boundingBox = CGRectMake(70.0, 150.0, 470.0, 270.0);
    vimeo.pageIndex = 3;
    [document addAnnotations:@[vimeo] options:nil];
    ...
    PSPDFLinkAnnotation *videoLink = [[PSPDFLinkAnnotation alloc] initWithURL:(NSURL *)[NSURL URLWithString:@"pspdfkit://[autoplay:false,coverMode:preview]localhost/Bundle/big_buck_bunny.mp4"]];
