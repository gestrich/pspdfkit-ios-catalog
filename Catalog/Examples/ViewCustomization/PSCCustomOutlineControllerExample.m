...
- (instancetype)init {
    if ((self = [super init])) {
        ...
        self.contentDescription = @"Shows to use a custom outline controller in the document info.";
...
- (void)viewDidLoad {
    ...
    [NSLayoutConstraint activateConstraints:
     @[
       [customLabel.topAnchor constraintEqualToAnchor:self.view.topAnchor constant:20.0],
       [customLabel.bottomAnchor constraintEqualToAnchor:self.view.bottomAnchor constant:-20.0],
...
- (nullable UIImage *)segmentImage {
    UIImage *image = [PSPDFKitGlobal imageNamed:@"x"];
    return image;
}
