...
- (void)printDocumentWithCustomOptions:(id)sender {
    ...
    PSPDFDocumentSharingViewController *sharingViewController = [[PSPDFDocumentSharingViewController alloc] initWithDocuments:@[self.document] sharingConfigurations:@[customPrintConfiguration]];
