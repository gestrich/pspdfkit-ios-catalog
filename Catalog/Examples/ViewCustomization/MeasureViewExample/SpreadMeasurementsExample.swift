...
/// Swift code from https://pspdfkit.com/guides/ios/current/customizing-pdf-pages/adding-auxiliary-or-decorative-views/
///
...
class SpreadMeasurementsExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        manager = .init()
        manager?.document = AssetLoader.document(withName: .quickStart)
