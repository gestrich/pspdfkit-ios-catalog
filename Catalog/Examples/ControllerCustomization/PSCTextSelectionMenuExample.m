...
- (NSArray<PSPDFMenuItem *> *)pdfViewController:(PSPDFViewController *)pdfController shouldShowMenuItems:(NSArray<PSPDFMenuItem *> *)menuItems atSuggestedTargetRect:(CGRect)rect forSelectedText:(NSString *)selectedText inRect:(CGRect)textRect onPageView:(PSPDFPageView *)pageView {
    ...
    PSPDFMenuItem *googleItem = [[PSPDFMenuItem alloc] initWithTitle:@"Google" block:^{
        ...
        [pdfController presentViewController:browser options:@{ PSPDFPresentationOptionSourceRect: @(rect), PSPDFPresentationOptionInNavigationController: @YES, PSPDFPresentationOptionCloseButton: @YES } animated:YES sender:nil completion:NULL];
