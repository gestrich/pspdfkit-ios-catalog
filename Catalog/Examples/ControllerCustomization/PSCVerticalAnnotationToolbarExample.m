...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder PSPDF_NOT_DESIGNATED_INITIALIZER_ATTRIBUTE;
...
- (void)viewDidLoad {
    ...
    self.verticalToolbar.frame = CGRectIntegral(CGRectMake(self.view.bounds.size.width - 44.0, (self.view.bounds.size.height - 44.0) / 2, 44.0, 44.0 * 4));
...
- (instancetype)initWithAnnotationStateManager:(PSPDFAnnotationStateManager *)annotationStateManager {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        self.backgroundColor = UIColor.psc_systemGroupedBackgroundColor;
        ...
        if ([pdfController.configuration.editableAnnotationTypes containsObject:PSPDFAnnotationStringInk]) {
            ...
            UIImage *sketchImage = [[PSPDFKitGlobal imageNamed:@"ink"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        if ([pdfController.configuration.editableAnnotationTypes containsObject:PSPDFAnnotationStringFreeText]) {
            ...
            UIImage *freeTextImage = [[PSPDFKitGlobal imageNamed:@"freetext"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        UIImage *undoImage = [[PSPDFKitGlobal imageNamed:@"undo"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        UIImage *redoImage = [[PSPDFKitGlobal imageNamed:@"redo"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
...
- (void)annotationStateManager:(PSPDFAnnotationStateManager *)manager didChangeState:(PSPDFAnnotationString)state to:(PSPDFAnnotationString)newState variant:(PSPDFAnnotationVariantString)variant to:(PSPDFAnnotationVariantString)newVariant {
    UIColor *selectedColor = [UIColor.psc_textColor colorWithAlphaComponent:0.2];
